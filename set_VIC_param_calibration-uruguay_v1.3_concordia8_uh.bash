...
path_out_vic='/home/gonzalo/Outputs/out-vic-8/' # modificar
path_out_route='/home/gonzalo/Outputs/out-rout-8/' # modificar
...
archivo_suelo_aux='soil_aux--Calibracion8.prn' 

# NOMBRES DE ARCHIVOS DE CONTROL DE LOS MODELOS
control_file_VIC='control_file_VIC-Calibracion8.prn'
control_file_route='control_file_route_calibracion_8.prn'
...
salida_RMSE='RMSE_uruguay_ByMyA--Calibracion_ERA_TERA8_2004-2010_Cascade_PELOTASyCANOAS.prn' # modificar
salida_NS='N-S_uruguay_ByMyA--Calibracion_ERA_TERA8_2004-2010_Cascade_PELOTASyCANOAS.prn' # modificar
#####################################################################
...
line="SOIL            ${path_control_vic}soil_aux--Calibracion8.prn"
...
line="${path_control_rout}Loca_7p8_gonza.asc"
